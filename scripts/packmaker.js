...
if(gid){
  fetch(`http://docs.google.com/spreadsheets/d/e/2PACX-1vT8YVHvDLdSca8w-AmHrHnZnhmRVHPsuXWwSybojAyKYVR2Ji_1wcPhReEvASZlhPG77HejdNKfISOr/pub?output=csv&gid=${gid}`).then(res => res.text()).then(c => {
    content = c;
