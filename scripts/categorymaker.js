...
fetch(`http://docs.google.com/spreadsheets/d/e/2PACX-1vT8YVHvDLdSca8w-AmHrHnZnhmRVHPsuXWwSybojAyKYVR2Ji_1wcPhReEvASZlhPG77HejdNKfISOr/pub?output=csv&gid=0`).then(res => res.text()).then(content => {
  packAttr = content.split("\r\n").slice(0,5);
  savePack(0);
})
